...
const Post = ({ post }: Props) => {
  ...
  return (
    <div
      role="button"
      className="rounded-lg bg-slate-200 transition-transform duration-300 hover:-translate-y-1 hover:shadow-lg"
    ...
    >
      ...
      <div className="p-4">
        ...
        <div className="mt-2 flex items-end justify-between">
          ...
          <span className="text-xs text-slate-900">{post.publishedAt}</span>
        </div>
      </div>
    </div>
  );
